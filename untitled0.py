...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 14 19:03:35 2021
...
ImageDataGen_test = ImageDataGenerator(rescale = 1./255)
...
dataset_test = ImageDataGen_test.flow_from_directory('output/test',
                                                    target_size = (64,64),
                                                    batch_size=32,
                                                    class_mode = None)
...
cnn.compile(optimizer = 'adam', metrics = ['accuracy'])
cnn.fit(x = dataset_train, validation_data = dataset_test, epochs = 25)
